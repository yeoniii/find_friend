...
public class ViewReceiveMessageController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{
			...
			msi.updateMessageState(map);
			msg = msi.viewReceiveMsg(map);
			session.setAttribute("messageInfo", msg);
	
			session.setAttribute("memName", msg.getMember().getMemberName());

			req.getRequestDispatcher("/messagejsp/view_receiveMessage.jsp").forward(req, resp);
